...
class ASTHelpers_Test(unittest.TestCase):
    ...
    def test_copy_location(self):
        ...
        self.assertEqual(ast.dump(src, include_attributes=True),
            "Expression(body=BinOp(left=Name(id='a', ctx=Load(), lineno=1, col_offset=0), "
            'op=Add(), right=Num(n=2, lineno=1, col_offset=4), '
    ...
    def test_increment_lineno(self):
        ...
        self.assertEqual(ast.dump(src, include_attributes=True),
            ...
            'op=Add(), right=Num(n=1, lineno=4, col_offset=4), '
...
single_results = [
('Interactive', [('Expr', (1, 0), ('BinOp', (1, 0), ('Name', (1, 0), 'a', ('Load',)), ('Add',), ('Num', (1, 2), 1)))]),
]
eval_results = [
