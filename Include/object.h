...
typedef struct _typeobject {
	...
	/* Added in wordcode-based Pythons. Used in compile.c. */
	hashfunc tp_relaxedhash; /* Works for lists and dicts too. */
	cmpfunc tp_equal; /* Calculates if two objects are equal (0.0 != -0.0) */
...
PyAPI_FUNC(int) PyObject_Equal(PyObject *, PyObject *);
