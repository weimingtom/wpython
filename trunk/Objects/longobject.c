...
static long
long_relaxedhash(PyLongObject *v)
{
	int hash = long_hash(v); /* relaxedhash must be different from ints */
	return hash == 0 ? -2 : hash - 1;
}

static int
long_equal(PyLongObject *a, PyLongObject *b)
{
...
PyTypeObject PyLong_Type = {
	...
	0,					/* tp_del */
	0,					/* tp_version_tag */
	(hashfunc)long_relaxedhash,					/* tp_relaxedhash */
	(cmpfunc)long_equal,					/* tp_equal */
};
