...
*/
int
PyObject_Equal(PyObject *v, PyObject *w)
{
...
static int
type_equal(PyTypeObject *a, PyTypeObject *b)
{
	return a == b;
}
...
static PyTypeObject PyNone_Type = {
	...
	0,					/* tp_del */
	0,					/* tp_version_tag */
	(hashfunc)_Py_HashPointer,					/* tp_relaxedhash */
	(cmpfunc)type_equal,					/* tp_equal */
};
