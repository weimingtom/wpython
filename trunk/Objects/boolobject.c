...
static long
bool_relaxedhash(PyBoolObject *v)
{
	return v->ob_ival;
}

static int
bool_equal(PyBoolObject *v, PyBoolObject *w)
{
	return v->ob_ival == w->ob_ival;
}
...
PyTypeObject PyBool_Type = {
	...
	0,					/* tp_del */
	0,					/* tp_version_tag */
	(hashfunc)bool_relaxedhash,					/* tp_relaxedhash */
	(cmpfunc)bool_equal,					/* tp_equal */
};
